  ...
  return (
    <main className="gap flex flex-grow flex-wrap items-center justify-center gap-4 bg-gray-100-tk px-2 py-2">
      <div className="max-h-[400px] max-w-[512px] h-[100%] w-[100%] rounded-[8px] bg-gray-300-tk px-2 py-3">
        <Form.Root className="flex flex-col gap-1 items-center justify-center">
          <fieldset className="mx-auto mb-1 max-w-[320px] text-center text-lg font-semi-bold leading-[26px] text-gray-900-tk">
          ...
          <Form.Field className="grid w-[100%]" name="codigo">
            <Form.Label
              className="text-left text-lg font-semi-bold text-gray-900-tk pb-1"
              htmlFor="codigo"
            >
          ...
          <Form.Submit asChild>
            <button className="flex justify-center max-h-[66px] max-w-[240px] items-center rounded bg-gray-900-tk p-0.75 text-lg font-semi-bold text-gray-100-tk">
              Continuar Cadastro
            </button>
          </Form.Submit>
        </Form.Root>
